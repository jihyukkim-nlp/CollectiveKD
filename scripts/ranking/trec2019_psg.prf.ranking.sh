...
queries=data/trec2019/queries.trec2019.tsv
...
fb_ranking=${exp_root}/TREC2019-psg/rerank.py/$(ls ${exp_root}/TREC2019-psg/rerank.py)/ranking.tsv
...
ranking=${prf_exp_root}/TREC2019-psg/label.py/$(ls ${prf_exp_root}/TREC2019-psg/label.py/ | grep 20*)/ranking.tsv
if [ ! -f ${ranking} ];then
    ...
    --checkpoint ${checkpoint} --root ${prf_exp_root} --experiment TREC2019-psg
else
