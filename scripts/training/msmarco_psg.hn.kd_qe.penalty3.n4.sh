...
EXP_ROOT_DIR=experiments/finetuned.b18.lr3e6.hn.kd_qe_kmeans.penalty3.n4
...
-m colbert.train --maxsteps 400000 --amp --bsize 18 --lr 3e-06 --accum 1 \
...
#TODO: sonic: gpu45-hn-kd_qe_kmeans-penalty3-n4-b18