...
EXP_ROOT_DIR=experiments/finetuned.b18.lr3e6.hn.kd_qe_kmeans.t100.n4
...
--knowledge_distillation --kd_temperature 1.0 --teacher_checkpoint ${checkpoint} \
...
#TODO: sonic: gpu67-hn-kd_qe_kmeans-t100-n4-b18