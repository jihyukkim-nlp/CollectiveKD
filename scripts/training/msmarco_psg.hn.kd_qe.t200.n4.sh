...
# - KD temperature: 0.100

#! --bsize 18, as we use 4 negative samples per query

EXP_ROOT_DIR=experiments/finetuned.b18.lr3e6.hn.kd_qe_kmeans.t200.n4
...
-m colbert.train --maxsteps 300000 --amp --bsize 18 --lr 3e-06 --accum 1 \
...
--knowledge_distillation --kd_temperature 2.0 --teacher_checkpoint ${checkpoint} \
...
#TODO: sonic: gpu45-hn-kd_qe_kmeans-t200-n4-b18