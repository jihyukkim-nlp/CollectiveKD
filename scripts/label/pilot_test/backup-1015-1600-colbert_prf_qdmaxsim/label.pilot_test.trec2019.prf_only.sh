...
rerank_experiment=qdmaxsim.prf_only.docs${fb_docs}.k${fb_k}.beta${beta} #TODO: custom path
...
#* {'ndcg_cut_10': 0.7069353550740398, 'ndcg_cut_200': 0.6688656365019279, 'map_cut_1000': 0.48504342800596373, 'recall_100': 0.5409008504077765, 'recall_200': 0.6462732907570575, 'recall_500': 0.7163474136731656, 'recall_1000': 0.751173547594718}
# 
...
# fb_docs: 3, fb_k: 10, beta: 1.0
#* {'ndcg_cut_10': 0.7136710419605535, 'ndcg_cut_200': 0.6737418701492256, 'map_cut_1000': 0.4937321787882359, 'recall_100': 0.5457759835883489, 'recall_200': 0.6499201106953912, 'recall_500': 0.7197940858567379, 'recall_1000': 0.7543616008089442}
# # 3-2. After filtering
# qrels_all=data/trec2019/2019qrels-pass.txt #TODO: custom path
# qrels_exclude=data/pilot_test/label/2019qrels-pass.train.tsv #TODO: custom path
