...
rerank_experiment=qdmaxsim.k${fb_k}.beta${beta} #TODO: custom path
...
if [ ! -f ${ranking_jsonl} ];then
    ...
    --fb_k ${fb_k} --beta ${beta} --score_by_range \
    --depth 1000
else
...
# fb_k: 10, beta: 1.0
#* {'ndcg_cut_10': 0.7369877593897983, 'ndcg_cut_200': 0.6874745987109044, 'map_cut_1000': 0.5023033901110171, 'recall_100': 0.5599274684100796, 'recall_200': 0.6497779615002911, 'recall_500': 0.7242451428973786, 'recall_1000': 0.7506573655887914}
# 
...
# fb_k: 10, beta: 1.0
#* {'ndcg_cut_10': 0.7536132253598935, 'ndcg_cut_200': 0.7007388207638663, 'map_cut_1000': 0.515618046361226, 'recall_100': 0.5643196130161435, 'recall_200': 0.6533570306727404, 'recall_500': 0.7276463107250652, 'recall_1000': 0.7538050907436037}
# # 3-2. After filtering
# qrels_all=data/trec2019/2019qrels-pass.txt #TODO: custom path
# qrels_exclude=data/pilot_test/label/2019qrels-pass.train.tsv #TODO: custom path
