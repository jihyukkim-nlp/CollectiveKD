...
rerank_experiment=qdmaxsim.prf.docs${fb_docs}.k${fb_k}.beta${beta} #TODO: custom path
...
if [ ! -f ${ranking_jsonl} ];then
    ...
    --fb_ranking experiments/pilot_test/trec2019/qdmaxsim.k10.beta1.0/label.py/2021-10-14_19.45.08/ranking.jsonl \
...
#* {'ndcg_cut_10': 0.7541692012686511, 'ndcg_cut_200': 0.7004804261347278, 'map_cut_1000': 0.5214911692321716, 'recall_100': 0.5700655932639987, 'recall_200': 0.6605099164445981, 'recall_500': 0.726612674827017, 'recall_1000': 0.7515797433165194}
# 
...
# fb_docs: 3, fb_k: 10, beta: 1.0
#* {'ndcg_cut_10': 0.7754553664157917, 'ndcg_cut_200': 0.712542013082173, 'map_cut_1000': 0.5330476424277744, 'recall_100': 0.5733634286672502, 'recall_200': 0.6636328135465818, 'recall_500': 0.7300805278037483, 'recall_1000': 0.7547285558416711}
# # 3-2. After filtering
# qrels_all=data/trec2019/2019qrels-pass.txt #TODO: custom path
# qrels_exclude=data/pilot_test/label/2019qrels-pass.train.tsv #TODO: custom path
