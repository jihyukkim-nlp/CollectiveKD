...
if [ ! -d "${rf_exp}" ];then
    echo "sh scripts/label/pilot_test/label.pilot_test.trec2019.sh ${device} ${rf_fb_k} ${rf_beta} ${rf_fb_clusters}"
    sh scripts/label/pilot_test/label.pilot_test.trec2019.sh ${device} ${rf_fb_k} ${rf_beta} ${rf_fb_clusters}
fi
