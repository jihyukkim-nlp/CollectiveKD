...
fb_clusters=$3 #TODO: input arg
fb_k=$4 #TODO: input arg
beta=$5 #TODO: input arg
...
rerank_experiment=kmeans.prf.docs${fb_docs}.clusters${fb_clusters}.k${fb_k}.beta${beta} #TODO: custom path
...
if [ ! -f ${ranking_jsonl} ];then
    ...
    \
    --prf --expansion_pt experiments/pilot_test/trec2019/kmeans.clusters12.k10.beta0.5/label.py/2021-10-14_04.38.31/expansion.pt \
    --fb_ranking experiments/pilot_test/trec2019/kmeans.clusters12.k10.beta0.5/label.py/2021-10-14_04.38.31/ranking.jsonl \
