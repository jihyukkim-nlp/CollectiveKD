...
rerank_experiment=kmeans.clusters${fb_clusters}.k${fb_k}.beta${beta} #TODO: custom path
...
if [ ! -f ${ranking_jsonl} ];then
    ...
    --fb_clusters ${fb_clusters} --fb_k ${fb_k} --beta ${beta} \
    --depth 1000
else
