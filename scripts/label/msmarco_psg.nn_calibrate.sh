#!/bin/bash
# Calibrate top-k passages using ColBERT-PRF

device=$1 #TODO: input arg, "0"
exp_root=$2 #TODO: input arg, e.g., "experiments/finetuned.b36.lr3e6.hn.kd_qe_kmeans_prf"
step=$3 #TODO: input arg, e.g., "150000"
# 
topk=$4 #TODO: input arg, e.g., "experiments/finetuned.b36.lr3e6.hn.kd_qe_kmeans_prf/MSMARCO-psg-HN/label.py/ranking.tsv"
fb_ranking=$5 #TODO: input arg, "experiments/finetuned.b36.lr3e6.hn.kd_qe_kmeans_prf/MSMARCO-psg-HN/label.py/ranking.jsonl"
fb_k=$6 #TODO: input arg, "10"
beta=$7 #TODO: input arg, "1.0"
fb_clusters=$8 #TODO: input arg, "24"
fb_docs=$9 #TODO: input arg, "3"
...
rerank_experiment=MSMARCO-psg-train-kmeans.rf.k${fb_k}.beta${beta}.clusters${fb_clusters} #TODO: custom path
...
for i in $(seq -f "%02g" 0 $(expr ${n_splits} - 1));do
    ...
    --queries ${small_queries} \
    --index_root ${index_root} --index_name MSMARCO.L2.32x200k --nprobe 32 --partitions 32768 \
    ...
    --fb_k ${fb_k} --beta ${beta} --fb_clusters ${fb_clusters} --depth 1000
