...
# ANN search
topk=${ckp_exp_root}/TREC2020-psg/retrieve.py/$(ls ${ckp_exp_root}/TREC2020-psg/retrieve.py)/unordered.tsv
if [ ! -f ${topk} ];then
    ...
    --checkpoint ${checkpoint} --root ${ckp_exp_root} --experiment TREC2020-psg
else
...
ranking=${ckp_exp_root}/TREC2020-psg/rerank.py/$(ls ${ckp_exp_root}/TREC2020-psg/rerank.py)/ranking.tsv
if [ ! -f ${ranking} ];then
...
# evaluate
ranking=${ckp_exp_root}/TREC2020-psg/rerank.py/$(ls ${ckp_exp_root}/TREC2020-psg/rerank.py)/ranking.tsv
result=${ckp_exp_root}/TREC2020-psg/e2e.metrics
