...
## Ours. ensemble-loss/finetuned.b36.lr3e6.hn.kd.t1.prf.docT5query.beta1.0
- Training using new train triples: 
   - HN (Hard Negatives) from pre-trained ColBERT 
...
- Training using KD (Knowledge Distillation) from pre-trained ColBERT using expanded query
   ...
   - T1: ColBERT-PRF (docT5query, beta 1.0) "experiments/colbert.teacher/MSMARCO-psg-train-prf.fb_docT5query.docs3.k10.beta1.0.clusters24/label.py/2021-11-07_23.05.35/expansion.pt"

colbert-50000.dnn : MRR@10 0.3642006640287441 (experiments/ensemble-loss/finetuned.b36.lr3e6.hn.kd.t1.prf.docT5query.beta1.0/MSMARCO-psg/test.py/2021-11-08_10.18.42/ranking.tsv)
colbert-100000.dnn: MRR@10 0.3659403283758589 (experiments/ensemble-loss/finetuned.b36.lr3e6.hn.kd.t1.prf.docT5query.beta1.0/MSMARCO-psg/test.py/2021-11-08_17.11.10/ranking.tsv)
...
colbert-200000.dnn: MRR@10 0.3635397621321693 (experiments/ensemble-loss/finetuned.b36.lr3e6.hn.kd.t1.prf.docT5query.beta1.0/MSMARCO-psg/test.py/2021-11-09_06.10.40/ranking.tsv)

## Ours. ensemble-loss/finetuned.b36.lr3e6.hn.kd.t1.prf.docT5query.beta0.5
- Training using new train triples: 
   - HN (Hard Negatives) from pre-trained ColBERT 
   - triple: "experiments/colbert.teacher/MSMARCO-psg-train-exp_embs0-exp_beta0/triples.train.small.ids.hn.jsonl"
- Training using KD (Knowledge Distillation) from pre-trained ColBERT using expanded query
   - Using ensemble of teachers
   - T1: ColBERT-PRF (docT5query, beta 0.5) "experiments/colbert.teacher/MSMARCO-psg-train-prf.fb_docT5query.docs3.k10.beta0.5.clusters24/label.py/2021-11-05_10.35.11/expansion.pt"

colbert-50000.dnn : MRR@10 0.36432397553099505 (experiments/ensemble-loss/finetuned.b36.lr3e6.hn.kd.t1.prf.docT5query.beta0.5/MSMARCO-psg/test.py/2021-11-08_10.18.24/ranking.tsv)
colbert-100000.dnn: MRR@10 0.36905523718560984 (experiments/ensemble-loss/finetuned.b36.lr3e6.hn.kd.t1.prf.docT5query.beta0.5/MSMARCO-psg/test.py/2021-11-08_17.10.54/ranking.tsv)
...
colbert-200000.dnn: MRR@10 0.36551359894483104 (experiments/ensemble-loss/finetuned.b36.lr3e6.hn.kd.t1.prf.docT5query.beta0.5/MSMARCO-psg/test.py/2021-11-09_06.07.05/ranking.tsv)

## Ours. ensemble-loss/finetuned.b36.lr3e6.hn.kd.t1.prf.beta0.5.t2.rf.beta0.5
- Training using new train triples: 
   - HN (Hard Negatives) from pre-trained ColBERT 
   - triple: "experiments/colbert.teacher/MSMARCO-psg-train-exp_embs0-exp_beta0/triples.train.small.ids.hn.jsonl"
- Training using KD (Knowledge Distillation) from pre-trained ColBERT using expanded query
...
colbert-100000.dnn: MRR@10  ()
colbert-150000.dnn: MRR@10  ()
colbert-200000.dnn: MRR@10  ()

## Ours. ensemble-loss/finetuned.b36.lr3e6.hn.kd.t1.prf.beta0.5.t2.prf.beta1.0
- Training using new train triples: 
   - HN (Hard Negatives) from pre-trained ColBERT 
   - triple: "experiments/colbert.teacher/MSMARCO-psg-train-exp_embs0-exp_beta0/triples.train.small.ids.hn.jsonl"
- Training using KD (Knowledge Distillation) from pre-trained ColBERT using expanded query
...
## Ours. ensemble-loss/finetuned.b36.lr3e6.hn.kd.t1.prf.beta0.5.t2.prf.docT5query.beta0.5
- Training using new train triples: 
   - HN (Hard Negatives) from pre-trained ColBERT 
   - triple: "experiments/colbert.teacher/MSMARCO-psg-train-exp_embs0-exp_beta0/triples.train.small.ids.hn.jsonl"
- Training using KD (Knowledge Distillation) from pre-trained ColBERT using expanded query
...
colbert-50000.dnn : MRR@10 0.3661126461090641 (experiments/ensemble-loss/finetuned.b36.lr3e6.hn.kd.t1.prf.beta0.5.t2.prf.docT5query.beta0.5/MSMARCO-psg/test.py/2021-11-08_20.10.32/ranking.tsv)
...
colbert-150000.dnn: MRR@10 0.3696128394051033 (experiments/ensemble-loss/finetuned.b36.lr3e6.hn.kd.t1.prf.beta0.5.t2.prf.docT5query.beta0.5/MSMARCO-psg/test.py/2021-11-08_22.59.50/ranking.tsv)
colbert-200000.dnn: MRR@10 0.36974149497430203 (experiments/ensemble-loss/finetuned.b36.lr3e6.hn.kd.t1.prf.beta0.5.t2.prf.docT5query.beta0.5/MSMARCO-psg/test.py/2021-11-09_06.06.51/ranking.tsv)

## Ours. ensemble-loss/finetuned.b36.lr3e6.hn.kd.t1.prf.beta1.0.t2.prf.docT5query.beta0.5
- Training using new train triples: 
   - HN (Hard Negatives) from pre-trained ColBERT 
   - triple: "experiments/colbert.teacher/MSMARCO-psg-train-exp_embs0-exp_beta0/triples.train.small.ids.hn.jsonl"
- Training using KD (Knowledge Distillation) from pre-trained ColBERT using expanded query
