...
## Ours. pseudo_positive_pretraining/pretrained.b36.lr3e6.hn.pp.kd.prf.beta0.5

Pre-tuning ColBERT using pseudo-positives
- Training using new train triples: ``experiments/colbert.teacher/MSMARCO-psg-train-kmeans.rf.k10.beta0.5.clusters10/label.py/triples.hn1.pp-topk3.with_lp.jsonl``
   - HN (Hard Negatives) from pre-trained ColBERT trained by BM25 negatives
...
- Training using KD (Knowledge Distillation) from ColBERT-PRF using expanded query

colbert-25000.dnn : MRR@10 0.3556577750488926 (experiments/pseudo_positive_pretraining/pretrained.b36.lr3e6.hn.pp.kd.prf.beta0.5/MSMARCO-psg/test.py/2021-11-03_18.54.57/ranking.tsv)
colbert-50000.dnn : MRR@10 0.35769113567107796 (experiments/pseudo_positive_pretraining/pretrained.b36.lr3e6.hn.pp.kd.prf.beta0.5/MSMARCO-psg/test.py/2021-11-03_21.43.00/ranking.tsv)
colbert-100000.dnn: MRR@10 0.35791382407786354 (experiments/pseudo_positive_pretraining/pretrained.b36.lr3e6.hn.pp.kd.prf.beta0.5/MSMARCO-psg/test.py/2021-11-04_09.39.53/ranking.tsv)
colbert-150000.dnn: MRR@10 0.3588807022331376 (experiments/pseudo_positive_pretraining/pretrained.b36.lr3e6.hn.pp.kd.prf.beta0.5/MSMARCO-psg/test.py/2021-11-04_12.33.40/ranking.tsv)
colbert-**200000**.dnn: MRR@10 **0.36533303770409736** (experiments/pseudo_positive_pretraining/pretrained.b36.lr3e6.hn.pp.kd.prf.beta0.5/MSMARCO-psg/test.py/2021-11-04_16.55.05/ranking.tsv)
colbert-250000.dnn: MRR@10 0.36239289125392243 (experiments/pseudo_positive_pretraining/pretrained.b36.lr3e6.hn.pp.kd.prf.beta0.5/MSMARCO-psg/test.py/2021-11-04_23.06.57/ranking.tsv)
colbert-300000.dnn: MRR@10 0.36174870377950546 (experiments/pseudo_positive_pretraining/pretrained.b36.lr3e6.hn.pp.kd.prf.beta0.5/MSMARCO-psg/test.py/2021-11-05_05.20.53/ranking.tsv)

## Ours. pseudo_positive_pretraining/pretrained.b36.lr3e6.hn.pp.kd.rf.beta0.5

Pre-tuning ColBERT using pseudo-positives
- Training using new train triples: ``experiments/colbert.teacher/MSMARCO-psg-train-kmeans.rf.k10.beta0.5.clusters10/label.py/triples.hn1.pp-topk3.with_lp.jsonl``
   - HN (Hard Negatives) from pre-trained ColBERT trained by BM25 negatives
   - PP (Pseudo Positives) from pre-trained ColBERT using expanded query from RF ("experiments/colbert.teacher/MSMARCO-psg-train-kmeans.rf.k10.beta0.5.clusters10/label.py/pseudo_qrels.*.tsv")
- Training using KD (Knowledge Distillation) from ColBERT-RF using expanded query

colbert-25000.dnn : MRR@10 0.35837460772274576 (experiments/pseudo_positive_pretraining/pretrained.b36.lr3e6.hn.pp.kd.rf.beta0.5/MSMARCO-psg/test.py/2021-11-03_18.58.02/ranking.tsv)
colbert-50000.dnn : MRR@10 0.36036373766316376 (experiments/pseudo_positive_pretraining/pretrained.b36.lr3e6.hn.pp.kd.rf.beta0.5/MSMARCO-psg/test.py/2021-11-03_21.43.21/ranking.tsv)
colbert-100000.dnn: MRR@10 0.3606243462045751 (experiments/pseudo_positive_pretraining/pretrained.b36.lr3e6.hn.pp.kd.rf.beta0.5/MSMARCO-psg/test.py/2021-11-04_09.40.16/ranking.tsv)
colbert-150000.dnn: MRR@10 0.3585356688042935 (experiments/pseudo_positive_pretraining/pretrained.b36.lr3e6.hn.pp.kd.rf.beta0.5/MSMARCO-psg/test.py/2021-11-04_12.33.50/ranking.tsv)
colbert-**200000**.dnn: MRR@10 **0.3657877382089418** (experiments/pseudo_positive_pretraining/pretrained.b36.lr3e6.hn.pp.kd.rf.beta0.5/MSMARCO-psg/test.py/2021-11-04_16.55.28/ranking.tsv)
colbert-250000.dnn: MRR@10 0.3604214422158546 (experiments/pseudo_positive_pretraining/pretrained.b36.lr3e6.hn.pp.kd.rf.beta0.5/MSMARCO-psg/test.py/2021-11-04_23.07.05/ranking.tsv)
colbert-300000.dnn: MRR@10 0.3614177695911218 (experiments/pseudo_positive_pretraining/pretrained.b36.lr3e6.hn.pp.kd.rf.beta0.5/MSMARCO-psg/test.py/2021-11-05_05.21.03/ranking.tsv)

## Ours. pseudo_positive_pretraining/pretrained.b36.lr3e6.hn.pp
...
colbert-25000.dnn : MRR@10 0.3576144994769645 (experiments/pseudo_positive_pretraining/pretrained.b36.lr3e6.hn.pp/MSMARCO-psg/test.py/2021-11-03_12.55.04/ranking.tsv)
colbert-50000.dnn : MRR@10 0.35973291035611926 (experiments/pseudo_positive_pretraining/pretrained.b36.lr3e6.hn.pp/MSMARCO-psg/test.py/2021-11-03_12.55.10/ranking.tsv)
colbert-75000.dnn : MRR@10 0.35859814890617137 (experiments/pseudo_positive_pretraining/pretrained.b36.lr3e6.hn.pp/MSMARCO-psg/test.py/2021-11-03_13.42.09/ranking.tsv)
colbert-100000.dnn: MRR@10 0.36035879155864786 (experiments/pseudo_positive_pretraining/pretrained.b36.lr3e6.hn.pp/MSMARCO-psg/test.py/2021-11-04_00.46.30/ranking.tsv)
colbert-150000.dnn: MRR@10 0.36043849774866976 (experiments/pseudo_positive_pretraining/pretrained.b36.lr3e6.hn.pp/MSMARCO-psg/test.py/2021-11-04_00.46.37/ranking.tsv)
colbert-**200000**.dnn: MRR@10 **0.36289620002728873** (experiments/pseudo_positive_pretraining/pretrained.b36.lr3e6.hn.pp/MSMARCO-psg/test.py/2021-11-04_03.49.20/ranking.tsv)
colbert-250000.dnn: MRR@10 0.3609995110747254 (experiments/pseudo_positive_pretraining/pretrained.b36.lr3e6.hn.pp/MSMARCO-psg/test.py/2021-11-04_06.53.52/ranking.tsv)
colbert-300000.dnn: MRR@10 0.36083918906626583 (experiments/pseudo_positive_pretraining/pretrained.b36.lr3e6.hn.pp/MSMARCO-psg/test.py/2021-11-04_12.01.20/ranking.tsv)
colbert-350000.dnn: MRR@10 0.3583334470368846 (experiments/pseudo_positive_pretraining/pretrained.b36.lr3e6.hn.pp/MSMARCO-psg/test.py/2021-11-04_16.34.38/ranking.tsv)
colbert-400000.dnn: MRR@10 gpu0 (experiments/pseudo_positive_pretraining/pretrained.b36.lr3e6.hn.pp/MSMARCO-psg/test.py/2021-11-04_21.54.26/ranking.tsv)
