...
\
--score_path_list \
analysis/calibration_on_presumed_negatives/trec${trec}/score.monoBERT.tsv \
analysis/calibration_on_presumed_negatives/trec${trec}/score.rf_then_prf.rf-k10.beta0.5.clusters10.prf-docs3.k10.beta0.5.clusters24.tsv \
analysis/calibration_on_presumed_negatives/trec${trec}/score.prf.fb_bm25.docs3.k10.beta0.5.clusters24.tsv \
analysis/calibration_on_presumed_negatives/trec${trec}/score.prf.fb_bm25.docs3.k10.beta1.0.clusters24.tsv \
analysis/calibration_on_presumed_negatives/trec${trec}/score.prf.docs3.k10.beta0.5.clusters24.tsv \
analysis/calibration_on_presumed_negatives/trec${trec}/score.prf.docs3.k10.beta1.0.clusters24.tsv \
analysis/calibration_on_presumed_negatives/trec${trec}/score.rf.k10.beta0.5.clusters10.tsv \
analysis/calibration_on_presumed_negatives/trec${trec}/score.rf.k10.beta1.0.clusters10.tsv \
analysis/calibration_on_presumed_negatives/trec${trec}/score.colbert.tsv \
\
--score_model_list \
'monoBERT' \
'ColBERT-RF-then-PRF (k 10, beta 0.5) (docs 3, k 10, beta 0.5)' \
'ColBERT-PRF (fb docT5query, docs 3, k 10, beta 0.5)' \
'ColBERT-PRF (fb docT5query, docs 3, k 10, beta 1.0)' \
'ColBERT-PRF (docs 3, k 10, beta 0.5)' \
'ColBERT-PRF (docs 3, k 10, beta 1.0)' \
'ColBERT-RF (k 10, beta 0.5)' \
'ColBERT-RF (k 10, beta 1.0)' \
'ColBERT' \
--output analysis/calibration_on_presumed_negatives/trec${trec}/scores_on_presumed_negatives.pkl
