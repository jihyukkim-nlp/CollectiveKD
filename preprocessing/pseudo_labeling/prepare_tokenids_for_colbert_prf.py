...
if __name__=='__main__':
    ...
    parser.add_argument('--index_path', help="/path/to/index.py/MSMARCO.L2.32x200k/ for sanity check")
    # parser.add_argument('--output', help="/path/to/msmarco_psg.tokenids.pt")
    ...
    # doclens_list = [json.load(open(file)) for file in doclens_filenames]
    doclens_list = []
